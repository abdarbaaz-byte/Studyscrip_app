            ...
            <CardContent className="p-8 space-y-8 text-left">
                ...
                <div className="space-y-4">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-base text-muted-foreground">
                        ...
                        <li>
                            <strong>सटीकता की कोई गारंटी नहीं:</strong> यद्यपि हम सटीक और नवीनतम जानकारी प्रदान کرنے کی کوشش کرتے ہیں, हम आवेदन में निहित जानकारी, उत्पादों, या सेवाओं की पूर्णता, सटीकता, विश्वसनीयता, या उपयुक्तता के बारे में किसी भी प्रकार की कोई वारंटी, व्यक्त या निहित, नहीं देते हैं। ऐसी जानकारी पर आपका कोई भी भरोसा सख्ती से आपके अपने जोखिम पर है।
                        </li>
<li>
