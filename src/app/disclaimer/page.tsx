            ...
            <CardContent className="p-8 space-y-8">
                ...
                <div className="space-y-4">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-base text-muted-foreground">
                        ...
                        <li className="text-justify">
                            <strong>व्यक्तिगत जिम्मेदारी:</strong> आप अपने सीखने और ज्ञान के उपयोग के लिए स्वयं जिम्मेदार हैं। हम किसी भी अकादミック या करियर परिणाम के लिए उत्तरदायी नहीं हैं। क्विज़ और पाठ्यक्रमों के परिणाम स्व-मूल्यांकन के लिए हैं और औपचारिक परीक्षाओं में सफलता की गारंटी नहीं देते हैं।
                        </li>
                        <li className="text-justify">
