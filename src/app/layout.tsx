...
export const metadata: Metadata = {
  ...
  keywords: ["online classes", "StudyScript", "Class 8", "Class 9", "Class 10", "Class 11", "Class 12", "NCERT solutions", "MP Board", "previous year question papers", "CBSE notes", "cuet", "ssc", "free study material", "free pdf notes", "MP board notes", "free pdf books", "Study script", "B.Pharma PCI", "M.Pharm PCI"],
