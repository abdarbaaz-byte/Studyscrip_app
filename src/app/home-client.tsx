      ...
      <div className="container mx-auto px-4">
        ...
        <>
          <section id="academics" className="pt-4 pb-8">
              ...
              {academicClasses.length === 0 && <p className="text-muted-foreground text-center">No academic classes found.</p>}
            </section>
            ...
            <section id="courses" className="pt-8 pb-12">
              ...
              {courses.length === 0 && <p className="text-muted-foreground text-center">No professional courses found.</p>}
            </section>
            ...
            <section id="batches" className="pt-8 pb-16">
              ...
              {batches.length === 0 && <p className="text-muted-foreground text-center">No active batches found.</p>}
            </section>
            ...
            <section id="reviews" className="pt-8 pb-16">
              ...
              {reviews.length > 0 ? (
                ...
                <p className="text-muted-foreground text-center">No reviews yet. Be the first to share your experience!</p>
              )}
